    ...
    <div className="collapse navbar-collapse" id="collapsibleNavbar">
      <ul className="col-12 d-flex justify-content-center navbar-nav">
        <li className="nav-item text-center">
          <a className={ "px-3 navbar-link " + (this.state.page.startsWith("index") || this.state.page==""
            ? "current-page" : "" ) } href="index.html">
            Home
          </a>
        </li>
        <li className="nav-item text-center">
          <a className={ "px-3 navbar-link " + (this.state.page.startsWith("about") ? "current-page" : "" ) }
            href="about.html">
            About
          </a>
        </li>
        <li className="nav-item text-center">
          <a className={ "px-3 navbar-link " + (this.state.page.startsWith("events") ? "current-page" : "" ) }
            href="events.html">
            Events
          </a>
        </li>
        <li className="nav-item text-center">
          <a className={ "px-3 navbar-link " + (this.state.page.startsWith("projects") ? "current-page" : "" ) }
            href="projects.html">
            Projects
          </a>
        </li>
        <li className="nav-item text-center">
          <a className={ "px-3 navbar-link " + (this.state.page.startsWith("articles") ? "current-page" : "" ) }
            href="articles.html">
            Articles
          </a>
        </li>
...
ReactDOM.render(
e(NavBar, { page: window.location.pathname.split("/").pop() }),
domContainer
);